...
# you can also do human.name + "-" + str(human.age)
# f"{human.name}-{str(human.age)}"
...
# I am uncertain if we are to return the same list exactly as the one above, in the range 27-32
# I have done it that way, and would be happy to do it differently if I am misunderstanding.
